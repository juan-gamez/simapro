...
class Horarios extends LoggedInController {
  ...
  function index()
  {
    $data['header']['title'] = 'Horarios';
    $data['aulas'] = $this->MAulas->getAulas();
    $data['asignaturas'] = $this->MAsignaturas->getAsignaturas_ciclo();
    $data['personal'] = $this->MPersonal->getPersonal();
    $data['codigo_aula'] = $this->uri->segment(3);

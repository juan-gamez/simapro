...
<div style="background: white; border: 1px solid #BBB; padding: 10px">
  ...
  <a href="/areas_administrativas/formulario_agregar" class="enlace-formulario"> <i class="fa fa-plus-circle"></i> &nbsp;Agregar Areas Administrativas</a><br>
...
<script>
  window.onload = function() {
    $('#example').DataTable( {
      ...
      "ajax": "/areas_administrativas/ajax",
      "language" : {

  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo isset($action)?$action:"/carreras/agregar" ?>">
          <?php $cn = "carreras_id" ?>
          <input type="hidden" name="<?=$cn?>" value="<?=set_value($cn, @$mod[$cn])?>">
          <div class="box-body">

            <div class="form-group">
            <?php $cn = "carreras_codigo" ?>
            ...
            <?php $cn = "carreras_escuelas" ?>
            <div class="form-group">
              <label for="<?=$cn?>">Escuelas</label><br>
